...
public class WydanieService {
    ...
    public List<WydanieListDto> getall(){

        Iterable<WydanieEntity> wydanie = wydanieRepository.findAll();
        List<WydanieListDto> dtos = WydanieMapper.mapEntityToListItemDto(wydanie);
    ...
    public void save(WydanieDto wydanieDto) {
        ...
        try {
            ...
            PracownicyEntity pracownicyRepo = pracownicyRepository.getByIdPrac(wydanieDto.getPracoId());
            SprzetEntity sprzetEntity  = sprzetRepository.getByIdSprzet(wydanieDto.getSprzetId());
            entity.setPracIdWydanie(pracownicyRepo);
            entity.setSprzet(sprzetEntity);
